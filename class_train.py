...
class BCNN(torch.nn.Module):
    ...
    def __init__(self, pretrain_model="model1_pretrain.pt"):
        ...
        self.conv3 = torch.nn.Conv2d(
            256, 384, kernel_size=3, stride=1, padding=1).cuda()

        self.conv4 = torch.nn.Conv2d(
            384, 384, kernel_size=3, stride=1, padding=1).cuda()

        self.conv5 = torch.nn.Conv2d(
            384, 256, kernel_size=3, stride=1, padding=1).cuda()
...
class TCNN(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = torch.nn.Conv2d(
            256, 256, kernel_size=3, stride=1, padding=0).cuda()
        self.conv2 = torch.nn.Conv2d(
            256, 128, kernel_size=3, stride=1, padding=0).cuda()
